...
This changes the weekend variable from a logical to a factor variable.
...
rides = 942 + 157 (temp in celsius) - 689(if weekend)
...
same thing as!!! temp_celsius \* weekend = temp + weekend +temp:weekend

946 + 157(temp in celsius) -702(weekend) + 0.74(temp celsius)(weekend)
...
rides = 1529 - 153(temp) -39.4(wind) - 696(weekend)
...
```{r}
library(here)
happy <- haven::read_dta( "Data/ess-stflife.dta")
